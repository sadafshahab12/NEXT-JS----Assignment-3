...
const Contacts = () => {
  return (
    <>
      <div className="bg-black text-white p-4 gap-5 rounded lg:h-[80vh] md:h-[100%] flex justify-center items-center flex-col">
        <div>
          <h1 className="font-bold text-3xl text-center pt-5">Contact Me</h1>
        </div>
        <div className="links mx-5 pt-10 gap-5 grid lg:grid-cols-2 md:grid-cols-3 sm:grid-cols-1">
